...
{ 
    ...
    public void calcResult() {
        ...
        if( numGuess == num1){System.out.println("Player one Won");}
        if( numGuess == num2){System.out.println("Player two Won");}
        if( numGuess == num3){System.out.println("Player three Won");}
